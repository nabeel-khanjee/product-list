    ...
    return ThemeData(
            ...
            textTheme: TextTheme(
              titleSmall: FontStylesConstants.nonito(
                  fontSize: 8, color: ColorConstants.white),
              titleMedium: FontStylesConstants.nonito(
                  fontSize: 10, color: ColorConstants.white),
              bodySmall: FontStylesConstants.nonito(
                  fontSize: 14, color: ColorConstants.white),
              ...
              labelMedium: FontStylesConstants.nonito(
                  fontSize: 22, color: ColorConstants.white),
              labelLarge: FontStylesConstants.nonito(
                  fontSize: 24, color: ColorConstants.white),
              headlineSmall: FontStylesConstants.nonito(
                  fontSize: 26, color: ColorConstants.white),
              headlineMedium: FontStylesConstants.nonito(
                  fontSize: 28, color: ColorConstants.white),
              headlineLarge: FontStylesConstants.nonito(
                  fontSize: 30, color: ColorConstants.white),
              displaySmall: FontStylesConstants.nonito(
                  fontSize: 32, color: ColorConstants.white),
              displayMedium: FontStylesConstants.nonito(
                  fontSize: 34, color: ColorConstants.white),
              displayLarge: FontStylesConstants.nonito(
                  fontSize: 36, color: ColorConstants.white),
            ),
          );
  }
