                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: InkWell(
                              onTap: () {
                                for (var element in question.value.options) {
                                  element.option == option.value.option
                                      ? element.isSelected = true
                                      : element.isSelected = false;
                                }
                                BlocProvider.of<GAD7Cubit>(context).updateIndex(
                                    score: getScoresGAD7(quesion: question));
                              },
                              child: Container(
                                decoration: BoxDecoration(
                                    borderRadius: BorderRadius.only(
                                      ...
                                      bottomRight: option.key ==
                                              question.value.options.length - 1
                                          ? const Radius.circular(10)
                                          : const Radius.circular(0),
                                    ),
